...
class DeviantArt(commands.Cog):
    ...
    async def cog_command_error(self, ctx, exc):
        """
        Catch 401 Unauthorized HTTPErrors which occur when
        the client's access token has become invalidated.
    ...
    def da_req(self, endpoint, **kwargs):
        ...
        of the module's builtin functions like deviantart.Api().browse.
        Kwargs used here can (and should) be taken from the URLs generated by
    ...
    async def gather_deviations(self, browse_func, ctx, *args, **kwargs):
        ...
        for i in range(self.search_limit):
            ...
            # Prevent an unnecessary API call on last iteration
    ...
    async def deviantart(self, ctx, *, query: utils.LiSQuery=None):
        ...
        ##nl## Note that this searches through titles, descriptions, *and* tags.
        ##nl## However, tag-like searches still work the best, so
        searching for `arcadiabay` instead of `arcadia bay`
